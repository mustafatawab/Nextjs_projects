...
export const mockImages: ImageData[] = [
  ...
  },
  {
    ...
    title: "City Lights",
    description:
      "The bustling energy of downtown at night with vibrant neon reflections on wet streets after rain.",
    image_url:
  ...
  },
  {
    ...
    title: "Forest Path",
    description:
      "A mysterious path winding through an ancient forest covered in morning mist, inviting exploration.",
    image_url:
  ...
  },
  {
    ...
    description:
      "Street portrait capturing the essence of city life and human connection in the urban environment.",
    image_url:
  ...
  },
  {
    ...
    title: "Desert Sunset",
    description:
      "Vibrant colors painting the sky over endless sand dunes in the Sahara Desert.",
    image_url:
  ...
  },
  {
    ...
    description:
      "Snow-covered peaks reflecting in a crystal-clear alpine lake during the quiet winter season.",
    image_url:
      "https://images.unsplash.com/photo-1551582045-6ec9c11d8697?w=800&h=800&fit=crop",
    is_published: false,
  ...
  },
  {
    ...
    title: "Flower Macro",
    description:
      "Delicate petals captured in stunning detail with morning dew drops creating natural diamonds.",
    image_url:
  ...
  },
  {
    ...
    description:
      "Modern architecture with clean lines and geometric patterns creating visual harmony.",
    image_url:
      "https://images.unsplash.com/photo-1511818966892-d7d671e672a2?w=800&h=800&fit=crop",
    is_published: true,
  ...
  },
  {
    ...
    description:
      "The art of coffee making captured in a cozy café setting with warm ambient lighting.",
    image_url:
  ...
  },
  {
    ...
    description:
      "Majestic lion captured in its natural habitat during the golden hour in African savanna.",
    image_url:
  ...
  },
  {
    ...
    description:
      "Clean, minimalist interior design showcasing the beauty of simplicity and natural light.",
    image_url:
