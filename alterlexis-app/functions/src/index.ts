...
// ... (All functions: sendWelcomeEmail, cleanupUserData, gumroadWebhook, resetDailyPlays, premiumExpirationReminder)

export const revokeExpiredPremiums = functions.pubsub.schedule('every day 01:00')
