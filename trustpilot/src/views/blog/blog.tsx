...
import { BlogType } from '@/utility/getBlogData'
        ...
        <main>
            <Wrapper>
                ...
                <section className='py-20'>
                    ...
                    <div className='py-5 flex flex-wrap xl:flex-nowrap justify-between gap-5'>

                        {/* <div className='flex gap-10'> */}
                        {blogs.items.map((item: any, idx: any) => {
                            ...
                            const category = blogs.includes.Entry.find((c: any) => c.sys.id === item.fields.category.sys.id)

                            const blogCategory = category.fields.blogCategory
                            ...
                            return (
                                ...
                                <>
                                    {blogCategory === 'Trends In Trust' && <div key={item.sys.id}>
                                        <Link href={`/blog/${blogCategory}/${item.sys.id}`}>
                                            <Image src={imageUrl} alt="" className='rounded-xl w-full h-60' />

                                            <p>
                                                <Link href={'/blog/trends-in-trust'} className=' text-blue-700 font-semibold mt-2'>{blogCategory}</Link>
                                            ...
                                            <p className='text-[#696A6A] font-light'>{item.fields.date}</p>

                                            {/* <p className=''>{documentToReactComponents(item.fields.body)}</p> */}
                                        </Link>
                                    </div>}
                    ...
                    <div className='py-5 flex flex-wrap xl:flex-nowrap justify-between gap-10'>
                        ...
                        {blogs.items.map((item: any, idx: any) => {
                            ...
                            return (
                                ...
                                <>
                                    {blogCategory === 'Reviews Matter' && <Link href={`/blog/reviews-matter/${item.fields.id}`}> <div key={item.sys.id}>
                    ...
                    <div className='py-5 flex flex-wrap xl:flex-nowrap justify-center gap-10'>
                        {blogs.items.map((item: any, idx: any) => {
                            ...
                            return (
                                ...
                                <>
                                    {blogCategory === 'Buy With Confidence' && <Link href={`/blog/buy-with-confidence/${item.fields.id}`}> <div key={item.sys.id}>
                        ...
                        {/* <Link href={'blog/buy-wit-confidence/Who does D.C. trust with big financial decisions?'}>
                            <div className='  basis-1/4 rounded-2xl flex justify-center items-center'>
                                <div className='w-full space-y-2'>
                                    <Image src={image1} alt='' className='rounded-xl w-full h-60' />
                                    <p>
                        ...
                        <Link href={'blog/buy-wit-confidence/4 Tips for sharing perfect product review photos'}>
                        ...
                        <Link href={'blog/buy-wit-confidence/5 Types of insurance to keep you and your assets safe'}>
