  ...
  return (
    <>
      <Wrapper>
        ...
        <Link className='text-blue-700 text-lg font-semibold' href='/blog/trend-in-trust'>See more articles</Link>
        </div>
        

          <main className='py-5 flex flex-wrap xl:flex-nowrap justify-between gap-5'>
            ...
            <div className='  basis-1/4 rounded-2xl flex  justify-center items-center'>
              <div className='w-full space-y-2'>
                ...
                <p>
                  <Link href={'/blog/trends-in-trust'} className=' text-blue-700 font-semibold mt-2'>Trends in Trust</Link>
