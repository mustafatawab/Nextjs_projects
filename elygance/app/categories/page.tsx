    ...
    <div className="container px-4 py-12 mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
          Explore our collection of luxury fragrances organized by category to
      ...
      <div className="mt-16">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Discover our specially curated collections designed for different
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="relative overflow-hidden rounded-lg border aspect-[3/4] group">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              ...
              <p className="mt-2 text-white/80">
                Light and refreshing scents perfect for warm days
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border aspect-[3/4] group">
            <Image
              src="https://images.unsplash.com/photo-1615160460367-dcccd27e11ad?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              ...
              <p className="mt-2 text-white/80">
                Premium fragrances crafted with rare ingredients
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border aspect-[3/4] group">
            <Image
              src="https://images.unsplash.com/photo-1724732678052-1437962cbbab?q=80&w=1335&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              ...
              <p className="mt-2 text-white/80">
                Our most iconic and beloved fragrances
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-16 bg-muted/50 rounded-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Not sure where to start? Discover fragrances based on your
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Explore our most popular fragrances loved by customers
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Discover our latest fragrances and limited editions
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Try before you buy with our curated sample collections
            </p>
          </Link>
        </div>
      </div>
